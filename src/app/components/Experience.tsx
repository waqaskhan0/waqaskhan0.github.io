...
const experiences = [
  {
    ...
    company: "Professional Experience · Islamabad, Pakistan",
    period: "2025 - Present",
    description: "Designed and shipped intelligent full-stack systems including an AI flood prediction dashboard, GIS disaster risk platform integrating NASA & USGS data, LLM-powered automation pipelines using n8n, and real-time KPI dashboards.",
    icon: Cpu,
    skills: ["Python", "Machine Learning", "n8n", "LLM APIs", "Geospatial Analysis"]
  },
  {
    title: "BS Artificial Intelligence",
    company: "National University of Modern Languages (NUML)",
    period: "2022 - 2026",
    description: "Coursework in ML, Deep Learning, Computer Vision, NLP, Neural Networks, Reinforcement Learning and DSA. Academic projects include Brain Tumor Detection (VGG-16), Real-Time CCTV Anomaly Recognition, and Sentiment Analysis.",
    icon: GraduationCap,
    skills: ["Deep Learning", "Computer Vision", "NLP", "Neural Networks", "DSA"]
  }
];
